                ...
                <div className="choose-main-con">
                    <div className="col">
                        <div className="card card-size" id="card-control">
                            <img className="choosing-card-img" src={WhyChoose1} alt="Card image cap" />
                    ...
                    <div className="col">
                        <div className="card card-size" id="card-control">
                            <img className="choosing-card-img" src={WhyChoose2} alt="Card image cap" />
                            <div className="card-body card-body1">
                    ...
                    <div className="col">
                        <div className="card card-size" id="card-control">
                            <img className="choosing-card-img" src={WhyChoose3} alt="Card image cap" />
                            <div className="card-body card-body1">
